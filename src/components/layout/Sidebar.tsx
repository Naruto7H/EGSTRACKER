...
export default function Sidebar() {
  ...
  return (
    <aside className="w-64 bg-white border-r min-h-screen flex flex-col p-6 shadow-sm hidden md:flex">
      <div className="flex items-center gap-2 mb-8">
        <div className="bg-primary p-2 rounded-lg">
          <Leaf className="h-5 w-5 text-white" />
        </div>
        <h1 className="text-xl font-bold tracking-tight text-slate-900">EcoTrack</h1>
      </div>
